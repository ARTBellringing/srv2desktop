...
Inherits WebToolbar
	...
	#tag Event
		Sub Opening()
		  ...
		  Self.Title = "SmART Ringer"
		  Self.Icon = SR2LetterLogo100x100
		  ...
		  btn.Caption = "Home"
		  btn.Tag = "Home"
		  btn.Icon = WebPicture.BootstrapIcon("house")
		  'btn.Icon = star
		  'btn.Badge = "5"
		  Self.AddItem(btn)
		  ...
		  'btn = New WebToolbarButton
		  'btn.Style = WebToolbarButton.ButtonStyles.PushButton // This is the default
		  'btn.Caption = "My Account"
		  'btn.Icon = WebPicture.BootstrapIcon("person")
		  'btn.Icon = star
		  'btn.Badge = "5"
		  'Self.AddItem(btn)
		  ...
		  btn.Menu.AddMenuItem(New WebMenuItem("menu item2"))
		  btn.Menu.AddMenuItem(New WebMenuItem("menu item3"))
		  Self.AddItem(btn)
		  ...
		  btn.Caption = "Logout"
		  btn.Tag = "Logout"
		  btn.Icon = WebPicture.BootstrapIcon("box-arrow-right")
		  Self.AddItem(btn)
